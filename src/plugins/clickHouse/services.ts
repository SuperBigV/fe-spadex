...
export function getDatabases(data: BaseParams): Promise<string[]> {
  return request('/api/spadex/db-databases', {
...
export function getTables(
  ...
  return request('/api/spadex/db-tables', {
    method: RequestMethod.Post,
    data,
  }).then((res) => {
    return res.dat || [];
...
> {
  return request('/api/spadex/db-desc-table', {
    method: RequestMethod.Post,
    data,
  }).then((res) => {
    return res.dat || [];
...
> {
  return request('/api/spadex/log-query-batch', {
    method: RequestMethod.Post,
    data,
    silence: true,
  }).then((res) => {
...
> {
  return request('/api/spadex/query-batch', {
    method: RequestMethod.Post,
    data,
    silence: true,
  }).then((res) => res.dat);
