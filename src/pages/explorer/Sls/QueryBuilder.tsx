    ...
    (val) => {
      if (datasourceValue && val) {
        getFullFields(datasourceValue, val, {
          ...
          const dateField = _.find(res.fields, { name: 'time' })?.name;
          const defaultDateField = _.find(res.fields, { name: 'time' })?.name;
          form.setFieldsValue({
            query: {
              ...query,
              ...
              <QuestionCircleOutlined
                onClick={() => {
                  DocumentDrawer({
                    ...
                    type: 'iframe',
                    documentPath: 'https://help.aliyun.com/zh/sls/user-guide/query-and-analyze-logs-in-index-mode/?spm=a2c4g.11186623.0.i61',
                  });
                }}
              />
            </Tooltip>
