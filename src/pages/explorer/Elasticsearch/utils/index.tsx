...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Returns a formatted field value based on the specified field configuration.
 *
 * @param {string} fieldKey - The key of the field to retrieve the value for.
 * @param {any} fieldValue - The raw value of the field.
 * @param {object} [fieldConfig] - Optional configuration object for the field formatting.
 *
 * @returns {string | JSX.Element} - Returns a formatted string if the field type is 'date',
 *                                   a JSX element linking to a URL if the field type is 'url',
 *                                   or the raw field value otherwise.
 */

/*******  544207ed-1c41-4fd0-97c8-7a369202b84c  *******/
