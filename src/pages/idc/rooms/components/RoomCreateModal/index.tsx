...
import { createRoom } from '@/pages/room/services';
import { RoomCreateData, RoomStatus, RoomType, RoomLevel } from '@/pages/room/types';
...
const RoomCreateModal: React.FC<RoomCreateModalProps> = ({ visible, onCancel, onSuccess }) => {
  ...
  return (
    ...
    >
      <Form form={form} layout='vertical' initialValues={{ status: 'active' }}>
        ...
        >
          <Input placeholder='请输入机房编号，如：ROOM-A-001' />
        </Form.Item>
