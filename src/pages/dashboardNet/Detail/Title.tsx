...
// const cachePageTitle = document.title || 'Spidex';
const cachePageTitle = 'Spadex';
              ...
              <RollbackOutlined
                ...
                onClick={() => {
                  goBack(history).catch(() => {
                    history.push(props.gobackPath || '/dashboards-net');
                  });
                }}
              />
            </Tooltip>
            <Space className='pr1'>
              <Link to={props.gobackPath || '/dashboards-net'} style={{ fontSize: 14 }}>
