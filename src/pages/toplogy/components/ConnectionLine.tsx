  ...
  return (
    ...
    >
      <svg width='100%' height='100%' className='line-svg'>
        {/* <line x1={x1} y1={y1} x2={x2} y2={y2} stroke={isSelected ? '#1890ff' : '#bfbfbf'} strokeWidth={isSelected ? '3' : '2'} /> */}
        <line x1={x1} y1={y1} x2={x2} y2={y2} stroke={isSelected ? '#1890ff' : '#bfbfbf'} strokeWidth={isSelected ? '3' : '2'} markerEnd={`url(#arrowhead-${connection.id})`} />
      </svg>
