...
export default function DetailV2(props: IProps) {
  const { isPreview = false, isBuiltin = false, gobackPath, builtinParams, dashboardId } = props;
  ...
  let id = dashboardId;
  const query = queryString.parse('?ident=all&search_string=all');
