        ...
        >
          {(form) => {
            ...
            if (cate === 'elasticsearch') {
              return <ElasticsearchSettings disabled={false} form={form} datasourceValue={datasourceValue} bgid={bgid} />;
            }
            if (cate === 'sls') {
              return <SlsSettings disabled={false} form={form} datasourceValue={datasourceValue} bgid={bgid} />;
            }
            if (cate === 'ck') {
