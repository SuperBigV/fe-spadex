...
import { getDefaultGids } from '@/components/BusinessGroup/BusinessGroupSideBarWithAll';
...
export default function index(props: IProps) {
  ...
  const { businessGroup, businessGroupOnChange, busiGroups, siteInfo, setBusiGroup } = useContext(CommonStateContext);
  ...
  // const [busiType, setBusiType] = useState<string>('busi');
  useEffect(() => {
